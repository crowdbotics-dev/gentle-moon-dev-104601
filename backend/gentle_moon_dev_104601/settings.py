"""
Django settings for gentle_moon_dev_104601 project.
...
ROOT_URLCONF = 'gentle_moon_dev_104601.urls'
...
WSGI_APPLICATION = 'gentle_moon_dev_104601.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gentle_moon_dev_104601 API",
    "DESCRIPTION": "API documentation for gentle_moon_dev_104601 App",
    "VERSION": "v1",
}
